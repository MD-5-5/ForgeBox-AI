...
export const listfiles = tool(
    async ({ }, config) => {
        //writer helps in firing the event
        const writer = config.writer;

        writer("Listing files in project sandbox...");
...
export const updatefiles = tool(
    ...
    {
        name: "update_files",
        description: "Update the content of specified files. This is useful for making changes to files based on the requirements of the task at hand. This tool can also used to create new files by providing a new file name in the file field and the content to be added in the content field.",
        schema: z.object({
            ...
            })).describe("List of file to be updated and their new contents.")
        })
    }
)
